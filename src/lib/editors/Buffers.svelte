<script lang="ts">
	...
	export let value = "Choose buffer" as string;
...
<svelte:component this={params.components['fieldWrapper']} {params} {schema}>
	<button class="btn flex items-center variant-filled w-64 justify-between" use:popup={popupCombobox}>
	...
	<div class="p-4 w-64 card shadow-xl z-10" data-popup={`popupCombobox-${uniqueId}`}>
		<TabGroup>
